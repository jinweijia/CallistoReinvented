...
class PostJobs():
    ...
    def makeRequest(self, url, method="GET", data={ }):
        ...
        try:
            ...
            if str(e).find("Connection refused") >= 0:
                print "Cannot connect to the server "+PostJobs.serverToTest+". You should start the server first, or pass the proper TEST_SERVER environment variable"
                sys.exit(1)
            raise
    ...
    def setUp(self):
        self.conn = httplib.HTTPConnection(PostJobs.serverToTest)
