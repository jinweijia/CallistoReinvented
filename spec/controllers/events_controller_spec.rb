...
RSpec.describe EventsController, :type => :controller do
  ...
  let(:valid_attributes) {
    # skip(" ")
    { company_id: 1, title: "test_event", type: "info-session", info: "test_info", date: "1501032307" }
  }

  let(:invalid_attributes) {
    # skip(" ")
    { company_id: 1, title: "", type: "info-session", info: "test_info", date: "1501032307" }
  }
  ...
  #       expect {
  #         post :create_event, {:event => valid_attributes}, valid_session
  ...
  #       post :create_event, {:event => invalid_attributes}, valid_session
  #       expect(assigns(:event)).to be_a_new(Event)
  #     end
